...
//            echo (@$val['brand']) ? $val['brand'] . " " : " ";
            ...
            ?>">
                <td class="carefree-title">
                    <span><img src="https://www.mytavia.com/beta/pub/media/catalog/product/cache/thumbnail/75x75/beff4985b56e3afdbeabfc89641a4582<?php echo $val['img']; ?>"></span> 
                    <h4><strong><?php echo $val['brand']; ?></strong> <?php echo $val['name']; ?></h4> 
                    <span class="responsive_show_icons">
                        <span class="hideinresponsive">
                            <?php
                            if (@$val['absorbancy']) {
                                $image = 'images/' . $val['absorbancy'] . '.png';
                                ?><span class="tooltiptitle" >Absorbancy</span>
                                <img src="<?php echo "https://www.mytavia.com/beta/pub/static/version1510299952/frontend/Magento/coustomTheme/en_US/" . $image; ?>">
                            <?php } ?>
                        </span >
                        <span class="hideinresponsive">
                            <?php if (@$val['scented']) { ?><span class="tooltiptitle" >Scented</span><img src="https://www.mytavia.com/beta/pub/static/version1509969426/frontend/Magento/coustomTheme/en_US/images/carefree-icon-2.png"><?php } ?> 
                            <?php if (@$val['deodorant']) { ?><span class="tooltiptitle" >Deodorant</span><img src="https://www.mytavia.com/beta/pub/static/version1509969426/frontend/Magento/coustomTheme/en_US/images/carefree-icon-3.png"><?php } ?>
                        </span>
                    </span>
                </td>
                <td class="carefree-icon hideicons">
                    ...
                    <span>
                        <?php if (@$val['scented']) { ?>
                            ...
                            <img src="https://www.mytavia.com/beta/pub/static/version1509969426/frontend/Magento/coustomTheme/en_US/images/carefree-icon-2.png"><?php } ?> 
                        <?php if (@$val['deodorant']) { ?>
                            <span class="tooltiptitle" >Deodorant</span>
                            <img src="https://www.mytavia.com/beta/pub/static/version1509969426/frontend/Magento/coustomTheme/en_US/images/carefree-icon-3.png"><?php } ?>
                    </span>
