...
class AbstractTransformer
{
    ...
    public function getItemStatus(Item $orderItem)
    {
        ...
        if ($this->isOrdered($canceledQty, $shippedQty, $refundedQty)) {
        ...
        if ($this->isShipped($orderedQty, $canceledQty, $shippedQty, $refundedQty)) {
     ...
     * @return boolean
     */
    protected function isOrdered($canceledQty, $shippedQty, $refundedQty)
    {
        return ($canceledQty == 0 && $shippedQty == 0 && $refundedQty == 0);
    }
     ...
     * @return boolean
     */
    protected function isShipped($orderedQty, $canceledQty, $shippedQty, $refundedQty)
    {
        if ($canceledQty == 0 && $refundedQty == 0 && $orderedQty == $shippedQty) {
            return true;
        }
